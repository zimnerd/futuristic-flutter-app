...
class PulseTextStyles {
  ...
  static const TextStyle displayLarge = TextStyle(
    ...
    fontSize: 57,
    fontWeight: FontWeight.w500, // Reduced from w700 for thinner appearance
    height: 1.12,
    letterSpacing: -0.25,
  );
  ...
  static const TextStyle displaySmall = TextStyle(
    fontFamily: fontFamily,
    fontSize: 36,
    fontWeight: FontWeight.w500, // Reduced from w600 for thinner appearance
    height: 1.22,
  );
  ...
  static const TextStyle labelLarge = TextStyle(
    fontFamily: fontFamily,
    fontSize: 14,
    fontWeight: FontWeight.w400, // Reduced from w500 for thinner appearance
    height: 1.43,
    letterSpacing: 0.1,
  );
