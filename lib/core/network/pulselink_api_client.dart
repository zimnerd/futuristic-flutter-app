...
/// PulseLink API client for all backend communication
/// 
/// This is the main API client that replaces all scattered API services 
...
class PulseLinkApiClient {
  late final Dio _dio;
  final Logger _logger = Logger();
  String? _authToken;

  static PulseLinkApiClient? _instance;
  static PulseLinkApiClient get instance => _instance ??= PulseLinkApiClient._();
  
  PulseLinkApiClient._() {
    _setupDio();
    _setupInterceptors();
  }
  ...
  Future<Response> updateNotificationPreferences(Map<String, dynamic> preferences) async {
