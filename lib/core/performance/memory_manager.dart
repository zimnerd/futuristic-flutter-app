...
class MemoryManager {
  ...
  final MessagePaginationOptimizer _messageOptimizer =
      MessagePaginationOptimizer();
  ...
  Future<bool> isMemoryUsageHealthy() async {
    ...
    return messageCount < maxHealthyMessages &&
        mediaCacheCount < maxHealthyMediaCache;
  }
